...
* fix: Normalize `dist/` to LF after ncc, ignore OS-specific source maps in CI, and keep helper scripts out of ESLint so Windows builds match Linux Verify bundled dist.
