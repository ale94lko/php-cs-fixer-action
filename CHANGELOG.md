...
* fix: Rebuild `dist/` from the PR head SHA without persisted credentials, and keep fork PRs out of that write path. [#63](https://github.com/ale94lko/php-cs-fixer-action/issues/63)
